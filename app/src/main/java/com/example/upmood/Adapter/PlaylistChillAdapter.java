...
public class PlaylistChillAdapter extends RecyclerView.Adapter<PlaylistChillAdapter.SongsViewHolder>{
    private List<Chill> songsList;
    private Context mContext;
    private OnChillItemClickListener mListener;
    private int lastPosition = -1;

    public PlaylistChillAdapter(Context context, List<Chill> songsList) {
        mContext = context;
