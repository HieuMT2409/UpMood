...
public class PlaylistTrendingActivity extends AppCompatActivity {

    private RecyclerView rcPlaylist;
    private PlaylistTrendingAdapter playlistAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        playlistAdapter = new PlaylistTrendingAdapter(this,songsList);
        ...
        playlistAdapter.setOnItemClickListener(new OnTopItemClickListener() {
            @Override
            public void onTopItemClick(TopTrending song, List<TopTrending> topTrendingList) {
                Intent intent = new Intent(PlaylistTrendingActivity.this, TopTrendingActivity.class);
                Bundle bundle = new Bundle();
                bundle.putSerializable("Playlist",song);
                bundle.putSerializable("listBaiHat", (Serializable) songsList);
                intent.putExtras(bundle);
                PlaylistTrendingActivity.this.startActivity(intent);
            }
        });
    ...
    private void DataIntent() throws IOException {
        ...
        if(intent != null){
            if(intent.hasExtra("music")){
                songs = (TopTrending) intent.getSerializableExtra("music");
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot snap : snapshot.getChildren()){
                    TopTrending song = snap.getValue(TopTrending.class);
                    songsList.add(song);
                }
