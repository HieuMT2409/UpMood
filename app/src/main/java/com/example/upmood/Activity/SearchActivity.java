    ...
    private void DataIntent() throws IOException {
        ...
        if(intent != null){
            if(intent.hasExtra("Search")){
                ...
                songs = (Search) bundle.getSerializable("Search");
                songsList = (List<Search>) bundle.getSerializable("listBaiHat");
                ...
                Glide.with(this)
                    ...
                    checkPlaylist = true;
                    Bundle bundle = intent.getExtras();
                    songs = (Search) bundle.getSerializable("Playlist");
                    songsList = (List<Search>) bundle.getSerializable("listBaiHat");
...
//                    circleVisualizer.setAudioSessionId(mediaPlayer.getAudioSessionId());
    ...
    private void setClick(Search song){
    ...
    private void Playlist(Search song) {
